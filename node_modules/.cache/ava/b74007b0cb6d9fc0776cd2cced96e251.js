...
test('save image', (() => {
  var _ref3 = _asyncToGenerator(function* (t) {
    ...
    t.truthy(_rec3._expr(_rec3._capt(_rec3._capt(created, 'arguments/0/object').createAt, 'arguments/0'), {
      content: 't.truthy(created.createAt)',
      filepath: 'test/db-test.js',
      line: 57,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"created","range":[9,16]},"property":{"type":"Identifier","name":"createAt","range":[17,25]},"computed":false,"range":[9,25]}],"range":[0,26]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"created","range":[9,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"createAt","range":[17,25]},{"type":{"label":")"},"range":[25,26]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
...
test('save user', (() => {
  var _ref7 = _asyncToGenerator(function* (t) {
    ...
    t.is(typeof created.id, 'string');
    t.truthy(_rec5._expr(_rec5._capt(_rec5._capt(created, 'arguments/0/object').createAt, 'arguments/0'), {
      content: 't.truthy(created.createAt)',
      filepath: 'test/db-test.js',
      line: 105,
      async: true,
...
//# sourceMappingURL=/var/www/html/platzigram-db/node_modules/.cache/ava/b74007b0cb6d9fc0776cd2cced96e251.js.map