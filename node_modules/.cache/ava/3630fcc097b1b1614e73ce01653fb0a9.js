...
test('get image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', '/var/www/html/platzigram-db/test/db-test.js', 80), _avaThrowsHelperEnd(t, db.getImage('foo'))), /not found/);
  });
...
test('get user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', '/var/www/html/platzigram-db/test/db-test.js', 119), _avaThrowsHelperEnd(t, db.getUser('foo'))), /not found/);
  });
...
//# sourceMappingURL=/var/www/html/platzigram-db/node_modules/.cache/ava/3630fcc097b1b1614e73ce01653fb0a9.js.map