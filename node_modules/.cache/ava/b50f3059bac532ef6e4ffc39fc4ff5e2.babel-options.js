...
const defaultOptions = envName => {
  return {
    ...
    "plugins": [],
    "presets": [
      "/var/www/html/platzigram-db/node_modules/@ava/babel-preset-stage-4/index.js",
      [
        "/var/www/html/platzigram-db/node_modules/@ava/babel-preset-transform-test-files/index.js",
        {
          "powerAssert": true
        }
      ]
